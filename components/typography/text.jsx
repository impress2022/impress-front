...
export default function Text(props) {
  let tagClasses = classNames({
    ...
    'text-1.25 leading-2.125 font-bold font-aller': props.size === 'body-bold-large',
    'text-1.75 leading-3r font-bold font-aller': props.size === 'body-xl',
    'text-1.375 md:text-1.625 leading-7 font-bold md:leading-2.125 font-aller': props.size === 'h3',
    'text-2.25 md:text-2.875 leading-3r font-normal md:leading-4r font-aller': props.size === 'h2',
