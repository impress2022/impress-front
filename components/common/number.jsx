...
export default function Number({children, direction}) {
  ...
  return (
    <div className="relative w-x2 h-x2">
      <Square sizeClasses="w-x2 h-x2" color="blue">
        <Text size="h2" color="white" custom="absolute font-aller top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">{children}</Text>
      </Square>
      <Square sizeClasses="w-xs1 h-xs1" color="green" customWrapper={squareClasses}/>
    </div>
  )
}