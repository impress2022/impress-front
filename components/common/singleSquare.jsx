      ...
      >
        <Link href="/nasze-realizacje">
          <div className="cursor-pointer">
            <Text
              size="h3"
              custom="absolute left-10 md:left-24 lg:left-7.5 top-10 md:top-16 lg:top-7.5 z-10"
            >
              {children}
            </Text>
            <svg
              className="absolute left-10 md:left-28 top-40 md:top-initial md:bottom-8 lg:bottom-28 z-10"
              width="34"
              height="34"
              viewBox="0 0 34 34"
              fill="none"
