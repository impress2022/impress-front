...
export default function Footer() {
  ...
  for (const value of menu.navigation) {
    c++;
    navItems.push(
      <li className="mb-4 md:mb-0 md:mr-4 lg:mr-5 md:flex md:items-center" key={c}>
  ...
  for (const value of menu.footer_navigation) {
    ...
    navSecondaryItems.push(
      <li className="mb-4 md:mb-0 md:ml-4 lg:ml-5 md:flex md:items-center" key={c}>
         ...
         <div className="container mx-auto">
           <div className="grid grid-cols-8 md:grid-cols-12 py-36">
             ...
             <div className="col-span-5 h-20 md:h-25 lg:ml-12 flex flex-col justify-center">
               <p className="text-white leading-7 text-1.375 md:text-3 md:leading-4r font-bold font-aller">Masz pomysł?</p>
           ...
           <div className="md:flex md:w-full pb-24">
             ...
             <div className="flex flex-row justify-between md:w-full">
              <ul className="md:flex lg:min-w-387">
                {navItems}
              </ul>
              ...
              <div className="text-right flex flex-col justify-between md:flex-row lg:w-full">
                ...
                <p className="text-0.75 leading-4.5 mb-4 md:mb-0 text-light-grey font-inter font-extralight md:ml-4 lg:ml-auto md:flex md:items-center">{footerCopy}</p>
              </div>
             </div>
           </div>
         </div>
